...
exports.gscReport = gscReport;
const gsc_site_snapshot_js_1 = require("./gsc-site-snapshot.js");
const gsc_quick_wins_js_1 = require("./gsc-quick-wins.js");
const gsc_traffic_drops_js_1 = require("./gsc-traffic-drops.js");
const gsc_content_decay_js_1 = require("./gsc-content-decay.js");
const gsc_alerts_js_1 = require("./gsc-alerts.js");
const gsc_content_recommendations_js_1 = require("./gsc-content-recommendations.js");
const ALL_SECTIONS = [
    "snapshot",
    "alerts",
    "quick_wins",
...
async function gscReport(days = 28, includeSections, dataset) {
    ...
    if (sections.includes("snapshot"))
        promises.snapshot = (0, gsc_site_snapshot_js_1.gscSiteSnapshot)(days, dataset);
    if (sections.includes("alerts"))
        promises.alerts = (0, gsc_alerts_js_1.gscAlerts)(7, 20, 50, 30, dataset);
    if (sections.includes("quick_wins"))
        promises.quick_wins = (0, gsc_quick_wins_js_1.gscQuickWins)(days, 50, 15, dataset);
    if (sections.includes("traffic_drops"))
        promises.traffic_drops = (0, gsc_traffic_drops_js_1.gscTrafficDrops)(days, dataset);
    if (sections.includes("content_decay"))
        promises.content_decay = (0, gsc_content_decay_js_1.gscContentDecay)(dataset);
